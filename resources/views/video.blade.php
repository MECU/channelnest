...
<div class="videocontent" style="background-color: #1b6d85">
    <video class="video-js vjs-default-skin vjs-16-9 vjs-big-play-centered" preload="auto" controls data-setup='{"fluid": true}'
           src="https://clips.dropcam.com/{{ video.id }}.mp4">
        <source src="https://clips.dropcam.com/{{ video.id }}.mp4" type="video/mp4">
        <p class="vjs-no-js">
